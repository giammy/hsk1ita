...
{ idx: '30', pidx: '29', nidx: '31',   title: '高兴',	label: 'gāoxìng',	desc: 'felice' },			    
{ idx: '31', pidx: '30', nidx: '32',   title: '个',	label: 'gè',	        desc: '[classificatore]' },		    
{ idx: '32', pidx: '31', nidx: '33',   title: '工作',	label: 'gōngzuò',	desc: 'lavoro' },			    
{ idx: '33', pidx: '32', nidx: '34',   title: '狗',	label: 'gǒu',	        desc: 'cane' },				    
{ idx: '34', pidx: '33', nidx: '35',   title: '汉语',	label: 'Hànyǔ',	        desc: 'la lingua Cinese' },		    
{ idx: '35', pidx: '34', nidx: '36',   title: '好',	label: 'hǎo',	        desc: 'bene' },				    
{ idx: '36', pidx: '35', nidx: '37',   title: '喝',	label: 'hē',	        desc: 'bere' },				    
{ idx: '37', pidx: '36', nidx: '38',   title: '和',	label: 'hé',	        desc: 'e' },				    
{ idx: '38', pidx: '37', nidx: '39',   title: '很',	label: 'hěn',	        desc: 'molto' },			    
{ idx: '39', pidx: '38', nidx: '40',   title: '后面',	label: 'hòumiàn',	desc: 'dietro' },			    
{ idx: '40', pidx: '39', nidx: '41',   title: '回',	label: 'huí',	        desc: 'ritornare' },			    
{ idx: '41', pidx: '40', nidx: '42',   title: '会',	label: 'huì',	        desc: 'potere' },			    
{ idx: '42', pidx: '41', nidx: '43',   title: '火车站',	label: 'huǒchēzhàn',	desc: 'stazione ferroviaria' },		    
{ idx: '43', pidx: '42', nidx: '44',   title: '几',	label: 'jǐ',	        desc: 'alcuni' },			    
{ idx: '44', pidx: '43', nidx: '45',   title: '家',	label: 'jiā',	        desc: 'casa' },				    
{ idx: '45', pidx: '44', nidx: '46',   title: '叫',	label: 'jiào',	        desc: 'chiamarsi' },			    
{ idx: '46', pidx: '45', nidx: '47',   title: '今天',	label: 'jīntiān',	desc: 'oggi' },				    
{ idx: '47', pidx: '46', nidx: '48',   title: '九',	label: 'jiǔ',	        desc: '9' },				    
{ idx: '48', pidx: '47', nidx: '49',   title: '开',	label: 'kāi',	        desc: 'aprire' },			    
{ idx: '49', pidx: '48', nidx: '50',   title: '看',	label: 'kàn',	        desc: 'vedere' },			    
{ idx: '50', pidx: '49', nidx: '51',   title: '看见',	label: 'kànjiàn',	desc: 'vedere' },			    
{ idx: '51', pidx: '50', nidx: '52',   title: '块',	label: 'kuài',	        desc: 'pezzo' },			    
{ idx: '52', pidx: '51', nidx: '53',   title: '来',	label: 'lái',	        desc: 'venire' },			    
{ idx: '53', pidx: '52', nidx: '54',   title: '老师',	label: 'lǎoshī',	desc: 'maestro' },			    
{ idx: '54', pidx: '53', nidx: '55',   title: '了',	label: 'le',	        desc: '[particella modale]' },		    
...
{ idx: '61', pidx: '60', nidx: '62',   title: '买',	label: 'mǎi',	        desc: 'comprare' },			    
{ idx: '62', pidx: '61', nidx: '63',   title: '猫',	label: 'māo',	        desc: 'gatto' },			    
{ idx: '63', pidx: '62', nidx: '64',   title: '没',	label: 'méi',	        desc: 'non' },				    
{ idx: '64', pidx: '63', nidx: '65',   title: '没关系',	label: 'méiguānxi',	desc: 'non importa' },			    
{ idx: '65', pidx: '64', nidx: '66',   title: '米饭',	label: 'mǐfàn',	        desc: 'riso' },				    
{ idx: '66', pidx: '65', nidx: '67',   title: '明天',	label: 'míngtiān',	desc: 'domani' },			    
{ idx: '67', pidx: '66', nidx: '68',   title: '名字',	label: 'míngzi',	desc: 'nome' },				    
{ idx: '68', pidx: '67', nidx: '69',   title: '哪',	label: 'nǎ',	        desc: 'quale?' },			    
{ idx: '69', pidx: '68', nidx: '70',   title: '哪儿',	label: 'nǎr',	        desc: 'dove?' },			    
{ idx: '70', pidx: '69', nidx: '71',   title: '那',	label: 'nà',	        desc: 'quello' },			    
{ idx: '71', pidx: '70', nidx: '72',   title: '那儿',	label: 'nàr',	        desc: 'lì' },				    
{ idx: '72', pidx: '71', nidx: '73',   title: '呢',	label: 'ne',	        desc: '[particella]' },			    
{ idx: '73', pidx: '72', nidx: '74',   title: '能',	label: 'néng',	        desc: 'potere' },			    
{ idx: '74', pidx: '73', nidx: '75',   title: '你',	label: 'nǐ',	        desc: 'tu' },				    
...
{ idx: '78', pidx: '77', nidx: '79',   title: '漂亮',	label: 'piàoliang',	desc: 'bella' },			    
{ idx: '79', pidx: '78', nidx: '80',   title: '苹果',	label: 'píngguǒ',	desc: 'mela' },				    
{ idx: '80', pidx: '79', nidx: '81',   title: '七',	label: 'qī',	        desc: '7' },				    
{ idx: '81', pidx: '80', nidx: '82',   title: '钱',	label: 'qián',	        desc: 'soldi' },			    
{ idx: '82', pidx: '81', nidx: '83',   title: '前面',	label: 'qiánmiàn',	desc: 'davanti' },			    
{ idx: '83', pidx: '82', nidx: '84',   title: '请',	label: 'qǐng',	        desc: 'prego' },			    
{ idx: '84', pidx: '83', nidx: '85',   title: '去',	label: 'qù',	        desc: 'andare' },			    
{ idx: '85', pidx: '84', nidx: '86',   title: '热',	label: 'rè',	        desc: 'caldo' },			    
{ idx: '86', pidx: '85', nidx: '87',   title: '人',	label: 'rén',	        desc: 'persona' },			    
{ idx: '87', pidx: '86', nidx: '88',   title: '认识',	label: 'rènshi',	desc: 'capire' },			    
{ idx: '88', pidx: '87', nidx: '89',   title: '日',	label: 'rì',	        desc: 'giorno' },			    
...
{ idx: '93', pidx: '92', nidx: '94',   title: '少',	label: 'shǎo',	        desc: 'poco' },				    
{ idx: '94', pidx: '93', nidx: '95',   title: '谁',	label: 'shéi',	        desc: 'chi?' },				    
{ idx: '95', pidx: '94', nidx: '96',   title: '什么',	label: 'shénme',	desc: 'cosa?' },			    
{ idx: '96', pidx: '95', nidx: '97',   title: '十',	label: 'shí',	        desc: '10' },				    
{ idx: '97', pidx: '96', nidx: '98',   title: '时候',	label: 'shíhou',	desc: 'tempo' },			    
{ idx: '98', pidx: '97', nidx: '99',   title: '是',	label: 'shì',	        desc: 'essere' },			    
{ idx: '99', pidx: '98', nidx: '100',  title: '书',	label: 'shū',	        desc: 'libro' },			    
{ idx: '100',pidx: '99', nidx: '101',  title: '水',	label: 'shuǐ',	        desc: 'acqua' },			    
{ idx: '101',pidx: '100',nidx: '102',  title: '水果',	label: 'shuǐguǒ',	desc: 'frutta' },			    
{ idx: '102',pidx: '101',nidx: '103',  title: '睡觉',	label: 'shuìjiào',	desc: 'dormire' },			    
{ idx: '103',pidx: '102',nidx: '104',  title: '说话',	label: 'shuōhuà',	desc: 'parlare' },			    
{ idx: '104',pidx: '103',nidx: '105',  title: '四',	label: 'sì',	        desc: '4' },				    
{ idx: '105',pidx: '104',nidx: '106',  title: '岁',	label: 'suì',	        desc: 'anno' },				    
{ idx: '106',pidx: '105',nidx: '107',  title: '他',	label: 'tā',	        desc: 'egli' },				    
{ idx: '107',pidx: '106',nidx: '108',  title: '她',	label: 'tā',	        desc: 'ella' },				    
{ idx: '108',pidx: '107',nidx: '109',  title: '太',	label: 'tài',	        desc: 'troppo' },			    
{ idx: '109',pidx: '108',nidx: '110',  title: '天气',	label: 'tiānqì',	desc: 'tempo' },			    
{ idx: '110',pidx: '109',nidx: '111',  title: '听',	label: 'tīng',	        desc: 'ascoltare' },			    
...
{ idx: '117',pidx: '116',nidx: '118',  title: '下',	label: 'xià',	        desc: 'sotto' },			    
{ idx: '118',pidx: '117',nidx: '119',  title: '下午',	label: 'xiàwǔ',	        desc: 'pomeriggio' },			    
{ idx: '119',pidx: '118',nidx: '120',  title: '下雨',	label: 'xiàyǔ',	        desc: 'piovere' },			    
{ idx: '120',pidx: '119',nidx: '121',  title: '先生',	label: 'xiānsheng',	desc: 'signore' },			    
{ idx: '121',pidx: '120',nidx: '122',  title: '现在',	label: 'xiànzài',	desc: 'ora' },				    
{ idx: '122',pidx: '121',nidx: '123',  title: '想',	label: 'xiǎng',	        desc: 'pensare' },			    
{ idx: '123',pidx: '122',nidx: '124',  title: '小',	label: 'xiǎo',	        desc: 'piccolo' },			    
{ idx: '124',pidx: '123',nidx: '125',  title: '小姐',	label: 'xiǎojiě',	desc: 'signorina' },			    
{ idx: '125',pidx: '124',nidx: '126',  title: '些',	label: 'xiē',	        desc: 'alcuni' },			    
{ idx: '126',pidx: '125',nidx: '127',  title: '写',	label: 'xiě',	        desc: 'scrivere' },			    
{ idx: '127',pidx: '126',nidx: '128',  title: '谢谢',	label: 'xièxie',	desc: 'grazie' },			    
{ idx: '128',pidx: '127',nidx: '129',  title: '星期',	label: 'xīngqī',	desc: 'settimana' },			    
{ idx: '129',pidx: '128',nidx: '130',  title: '学生',	label: 'xuésheng',	desc: 'studente' },			    
{ idx: '130',pidx: '129',nidx: '131',  title: '学习',	label: 'xuéxí',	        desc: 'studiare' },			    
...
{ idx: '137',pidx: '136',nidx: '138',  title: '有',	label: 'yǒu',	        desc: 'avere' },			    
{ idx: '138',pidx: '137',nidx: '139',  title: '月',	label: 'yuè',	        desc: 'mese' },				    
{ idx: '139',pidx: '138',nidx: '140',  title: '在',	label: 'zài',	        desc: 'in' },				    
{ idx: '140',pidx: '139',nidx: '141',  title: '再见',	label: 'zàijiàn',	desc: 'arrivederci' },			    
{ idx: '141',pidx: '140',nidx: '142',  title: '怎么',	label: 'zěnme',	        desc: 'come' },				    
{ idx: '142',pidx: '141',nidx: '143',  title: '怎么样',	label: 'zěnmeyàng',	desc: 'in che modo' },			    
...
{ idx: '147',pidx: '146',nidx: '148',  title: '住',	label: 'zhù',	        desc: 'vivere' },			    
{ idx: '148',pidx: '147',nidx: '149',  title: '桌子',	label: 'zhuōzi',	desc: 'tavolo' },			    
{ idx: '149',pidx: '148',nidx: '150',  title: '字',	label: 'zì',	        desc: 'parola' },			    
{ idx: '150',pidx: '149',nidx: '151',  title: '昨天',	label: 'zuótiān',	desc: 'ieri' },				    
{ idx: '151',pidx: '150',nidx: '152',  title: '坐',	label: 'zuò',	        desc: 'sedersi' },			    
{ idx: '152',pidx: '151',nidx: '0',    title: '做',	label: 'zuò',	        desc: 'fare' }                              
